      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
              ...
              <h2><asp:Label ID="lblLoginLossHeader" runat="server" Text="Ingresar Contraseña Nueva"></asp:Label></h2><br />
              <div class="row">
                  <div class="col-md-1" style="text-align:center;">
                    <i class="fa fa-lock" style="font-size:20px;margin-top:5px;"></i>
                  </div>
                  <div class="col-md-11">
                    <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control" Text="Nueva Contraseña" Style="border-top:none;border-right:none;border-left:none;"></asp:TextBox>
                  </div>
              </div>
              <br />
              <div class="row">
                  ...
                  <div class="col-md-11">
                    <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" Text="Confirmar Contraseña" Style="border-top:none;border-right:none;border-left:none;"></asp:TextBox>
                  </div>
              </div>
              <br /><br />
            <div>
              ...
              <div><br />
                  <div class="row">
                      <div class="col-md-12" style="text-align:center;">
                          <asp:Button ID="btnRecuperarContrasena" runat="server" CssClass="btn btn-primary" Text=" Recuperar " Style="width:100%;" />  
                      </div>
                  </div>
                  <br />
