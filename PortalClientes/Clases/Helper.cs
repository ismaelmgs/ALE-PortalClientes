...
namespace PortalClientes.Clases
{
    public class Helper
    {
        ...
        public const string D_UrlObtieneGraficaGastoTotal = "http://201.163.208.231/" + DominioWS + "/ws/pc/ObtieneGraficaGastoTotal";
        public const string D_UrlObtieneGraficaCostoHoraVuelo = "http://201.163.208.231/" + DominioWS + "/ws/pc/ObtieneGraficaCostoHoraVuelo";
