    ...
    <div class="row">
        <div class="col-md-6">
            <div class="title_left">
                <h3><asp:Label ID="lblSesionExp" runat="server" Text="Sesión Expirada"></asp:Label></h3>
            </div>
        </div>
        <div class="col-md-6">
        ...
        <div class="x_panel">
            ...
            <div class="row">
                ...
                <div class="col-md-6" style="text-align:center;">
                    ...
                    <asp:LinkButton ID="btnRegresarLogin" runat="server" Text="<i class='fa fa-undo' style='color:#73879C;font-size:14px;'></i> Regresar a Acceso <span class='glyphicon glyphicon-off' style='color:#73879C;font-size:14px;'></span>" CssClass="btn" href="../login.aspx" />
                </div>
                <div class="col-md-3">&nbsp;</div>
            </div>
        </div>
