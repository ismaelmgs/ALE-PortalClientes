                                ...
                                <div class="row" style="margin: 0px;">
                                    <div class="col-md-12 table-responsive" style="padding-left: 1px !important; padding-right: 1px !important">
                                        <table class="table" style="border: 0px;">
                                            ...
                                            <tr style="background-color: #00000003;">
                                                <td style="border-bottom: 1px solid #dee2e6; padding: 6px;">
                                                    <asp:LinkButton runat="server" ID="btnDetReporte2" OnClick="btnDetReporte_Click" data-report="2" data-rpt="0" OnClientClick="openLoading()">
                                                        <img src="../build/images/detalle_gatos.png" style="width: 32px;" />&nbsp;
                                                        <span style="font-size: 17px; font-weight: bold;">
                                            ...
                                            <tr style="background-color: #00000003;">
                                                <td style="border-bottom: 1px solid #dee2e6; padding: 6px;">
                                                    <asp:LinkButton runat="server" ID="btnDetReporte3" OnClick="btnDetReporte_Click" data-report="3" data-rpt="0" OnClientClick="openLoading()">
                                            ...
                                            <tr style="background-color: #00000003;">
                                                <td style="border-bottom: 1px solid #dee2e6; padding: 6px;">
                                                    <asp:LinkButton runat="server" ID="btnResGastosVuelos" OnClick="btnDetReporte_Click" data-report="4" data-rpt="1" OnClientClick="openLoading()">
                                            ...
                                            <tr style="background-color: #00000003;">
                                                <td style="border-bottom: 1px solid #dee2e6; padding: 6px;">
                                                    <asp:LinkButton runat="server" ID="btnDetGastosVuelos" OnClick="btnDetReporte_Click" data-report="5" data-rpt="0" OnClientClick="openLoading()">
                                            ...
                                            <tr style="background-color: #00000003;">
                                                <td style="border-bottom: 1px solid #dee2e6; padding: 6px;">
                                                    <asp:LinkButton runat="server" ID="btnGastoCombustibleVuelo" OnClick="btnDetReporte_Click" data-report="6" data-rpt="0" OnClientClick="openLoading()">
                                            ...
                                            <tr style="background-color: #00000003;">
                                                <td style="border-bottom: 1px solid #dee2e6; padding: 6px;">
                                                    <asp:LinkButton runat="server" ID="btnIngresosGastos" OnClick="btnDetReporte_Click" data-report="7" data-rpt="0" OnClientClick="openLoading()">
