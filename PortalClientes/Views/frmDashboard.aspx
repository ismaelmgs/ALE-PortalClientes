...
AutoEventWireup="true" CodeBehind="frmDashboard.aspx.cs" UICulture="es"
Culture="es-MX" Inherits="PortalClientes.Views.frmDashboard" %> <%@ Register
Assembly="DevExpress.Web.Bootstrap.v18.1, Version=18.1.15.0, Culture=neutral,
PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.Bootstrap"
TagPrefix="dx" %>
		...
		<ContentTemplate>
					...
					<div class="x_panel">
						...
						<div class="row">
									...
									<div class="col-md-12" style="text-align: center">
										<span
											style="
												...
												margin: 4px;
											"
											><i class="fa fa-plane" style="padding: 5px"></i></span
										>&nbsp;&nbsp;<asp:Label
											ID="lblCompleto"
											runat="server"
											Text=""
								...
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									<li class="nav-item">
										<a
											...
											aria-selected="true"
										>
											<asp:Label ID="lblVuelos" runat="server"></asp:Label
										></a>
									</li>
									<li class="nav-item">
										<a
											...
											aria-selected="false"
										>
											<asp:Label ID="lblHorasVuelo" runat="server"></asp:Label
										></a>
									</li>
									<li class="nav-item">
										<a
											...
											aria-selected="false"
										>
											<asp:Label ID="lblNMVuelo" runat="server"></asp:Label
										></a>
									</li>
								</ul>
							...
							<div class="col-md-8">
								...
								<%--<iframe
									src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15008005.624851545!2d-111.65547970087938!3d23.313441203547026!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x84043a3b88685353%3A0xed64b4be6b099811!2zTcOpeGljbw!5e0!3m2!1ses!2smx!4v1629999888503!5m2!1ses!2smx"
									width="100%"
									height="450"
									style="border: 0"
									allowfullscreen=""
						...
						<div class="x_title">
							<div class="row">
								<div class="col-md-6">
									<h2>
										<asp:Label
											ID="lblResumenDeCuenta"
											runat="server"
											Text=""
											Font-Bold="true"
										></asp:Label>
										<asp:Label
											ID="lblMatriculaAeronave"
											runat="server"
											Text=""
											Font-Bold="true"
										></asp:Label>
			...
			padding: 5px;"><asp:Label ID="lblHeaderDudasAclaraciones" runat="server" Text="Dudas o Aclaraciones" Font-Bold="true"></asp:Label></h5>
									...
									<%--<span data-toggle="popover"
										title="<strong>Dudas o Aclaraciones</strong>"
										data-html="true"
										data-content="Favor de comunicarse con:<br /> <strong>Miguel Ríos</strong><br /> al teléfono:<br /> <a href='tel:+525555555555'> <strong>(55) 5555 5555</strong></a>">
										<i class="fa fa-question-circle" style="font-size: 35px;margin-top: 5px; cursor: pointer; color: #73879c;"></i>
									</span>--%>
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<asp:Label
									ID="lblUltimaDeclaracion"
									runat="server"
									Text="Ultima declaración"
									Font-Bold="true"
								></asp:Label
								><br />
								<span style="font-size: 30px">
									<asp:Label
										ID="lblUtimaDeclaracionSimbolo"
										runat="server"
										Text=" $"
										Font-Bold="true"
										CssClass="count2" />
									<asp:Label
										ID="lblultimaDeclaracionText"
										runat="server"
										Text="58,182.87"
										Font-Bold="true"
									></asp:Label
				...
				<div class="col-md-12 col-sm-12">
					<div class="x_panel">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div id="piechart_3d_2" style="min-height: 400px"></div>
							</div>
						</div>
					</div>
				</div>
			...
			<script
				src='<%=ResolveUrl("~/build/js/GraficasJS/GraficasDashboard.js")%>'
			></script>
