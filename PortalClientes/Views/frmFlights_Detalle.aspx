        ...
        <ContentTemplate>
            ...
            <div class="row">
                ...
                <div style="width: 100%; text-align: center;">
                    <asp:LinkButton ID="btnRegresarVuelosEng" runat="server" Text="<i class='fa fa-undo' style='color:#73879C;font-size:14px;'></i> Flights <i class='fa fa-space-shuttle' style='color:#73879C;font-size:14px;'></i>" CssClass="btn" href="frmFlights.aspx" />
                    <asp:LinkButton ID="btnRegresarVuelos" runat="server" Text="<i class='fa fa-undo' style='color:#73879C;font-size:14px;'></i> Vuelos <i class='fa fa-space-shuttle' style='color:#73879C;font-size:14px;'></i>" CssClass="btn" href="frmFlights.aspx" />
                </div>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
